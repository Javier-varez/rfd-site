  ...
  return (
    <>
      <button
        ...
        className="max-600:hidden text-tertiary bg-secondary border-secondary elevation-1 hover:bg-tertiary flex h-8 w-8 items-center justify-center rounded border"
